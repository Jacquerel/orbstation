...
/// From /datum/action/cooldown/item_dash/proc/teleport when teleport is successful
#define COMSIG_DASH_ACTION_DASHED "dash_action_dashed"
/// From /datum/action/cooldown/item_dash/proc/charge when charges are replenished
