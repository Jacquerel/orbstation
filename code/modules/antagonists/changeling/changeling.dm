...
/datum/antagonist/changeling/apply_innate_effects(mob/living/mob_override)
	...
	living_mob.add_traits(list(TRAIT_FAKE_SOULLESS, TRAIT_MALLEABLE_BODY), CHANGELING_TRAIT)
...
/datum/antagonist/changeling/remove_innate_effects(mob/living/mob_override)
	...
	living_mob.remove_traits(list(TRAIT_FAKE_SOULLESS, TRAIT_MALLEABLE_BODY), CHANGELING_TRAIT)
